...
function RightSection() {
  ...
  return (
    <div className="flex flex-col justify-center p-10 md:p-20 items-center">
      ...
      {/* Google Login */}
      <button className="border-none flex items-center justify-center gap-3 py-3 rounded-lg mb-4 hover:bg-blue-300 transition bg-blue-400 cursor-pointer w-full max-w-md" onClick={handleGoogle}>
        <img
